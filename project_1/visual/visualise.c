 ...
 */
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_dc_unsigned_int(__pyx_v_res, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 33, __pyx_L1_error)
 ...
 */
  __pyx_t_8 = 0;
  __pyx_v_nl = qtenv_insert(__pyx_v_self->this, (&(*((unsigned int *) ( /* dim=0 */ ((char *) (((unsigned int *) __pyx_v_res_mv.data) + __pyx_t_8)) )))));
 ...
 */
  ...
  __pyx_t_6 = __Pyx_PyInt_From_unsigned_int(__pyx_v_nl); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
